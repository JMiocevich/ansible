...
require('lazy').setup({
  ...
  },
  {
    ...
    init = function()
      ...
      vim.g.python3_host_prog = vim.fn.expand '~/work/gridcog_sim/gridcog/venv/bin/python3'
    end,
  },
  ...
  },
  {
    ...
    config = function()
      ...
      --    function will be rxecuted to configure the current buffer
...
vim.keymap.set('n', '<leader>w', ':Explore<CR>', { noremap = true, silent = true })
